...
build:
	...
	go build -o polygon-edge -ldflags="\
    	-X 'github.com/RavenspiritMedia/Indra-chain/versioning.Version=$(LATEST_VERSION)' \
		-X 'github.com/RavenspiritMedia/Indra-chain/versioning.Commit=$(COMMIT_HASH)'\
		-X 'github.com/RavenspiritMedia/Indra-chain/versioning.Branch=$(BRANCH)'\
		-X 'github.com/RavenspiritMedia/Indra-chain/versioning.BuildTime=$(TIME)'" \
	main.go
